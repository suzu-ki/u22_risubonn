...
const TaskTable = ({ taskGroups, setTaskGroups, tagOptions, selectedTask, setSelectedTask }) => {
  ...
  // const updateTask2 = async(groupId, taskId, key, value) => {
  //   setTaskGroups((prev) =>
  //     prev.map((group) =>
  //       group.id === groupId
  //         ? {
  ...
  //   );
  //   try {
  //     const updatedTask = taskGroups.find(g => g.id === groupId)
  //       ?.tasks.find(t => t.id === taskId);
  //     if (updatedTask) {
  //       const mess = await window.electronAPI.saveExceldata({ ...updatedTask, [key]: value }, null);
  //       console.log(mess)
  //     }
  //   } catch (e) {
  //     console.error("Excel保存失敗", e);
  ...
  // const toggleSubtaskStatus2 = (groupId, taskId, subtaskIndex) => {
  //     setTaskGroups(prev =>
  //       prev.map(group =>
  //         group.id === groupId
  //           ? {
  ...
  //                         idx === subtaskIndex ? { ...st, 進捗: !st.進捗 } : st
  //                       ),
  //                     }
  //                   : task
  //               ),
